...
\draw (-2,-1,0)--(-2,-1,1)--(2,-1,1)--(2,-1,0)--cycle;
\draw (-2,1,0)--(-2,1,1)--(2,1,1)--(2,1,0)--cycle;
\draw (-2,-1,1)--(2,-1,1)--(2,1,1)--(-2,1,1)--cycle;
\draw[rotate=90] (-2,0,0) circle (0.5);
%(Label(XY()*"$x$",align=-3Y));
...
\filldraw[draw=none,fill=white](-2,0)--(2,0)--(2,1)--(-2,1)--cycle;
\draw(2,0)--(2,1)--(-2,1)--(-2,0);
\filldraw[fill=white](-2,-.985)--(2,-.985)--(2,.985)--(-2,.985)--cycle;
\filldraw[fill=white](-2,-.985)--(-2,-1.158)--(2,-1.158)--(2,-.985)--cycle;
\filldraw[draw=none,fill=white](-2,0)--(-2,-1)--(2,-1)--(2,0)--cycle;
\draw(-2,0)--(-2,-1)--(2,-1)--(2,0);
\filldraw[fill=white](-2,1)--(-2,1)--(2,1)--(2,1)--cycle;
\filldraw[draw=none,fill=white](-2,-.087)--(-2,-1.158)--(2,-1.158)--(2,-.087)--cycle;
\draw(-2,-.087)--(-2,-1.158)--(2,-1.158)--(2,-.087);
\filldraw[fill=white](-2,-1)--(-2,-1)--(2,-1)--(2,-1)--cycle;
\filldraw[draw=none,fill=white](-2,.839)--(-2,-1)--(2,-1)--(2,.839)--cycle;
\draw(-2,.839)--(-2,-1)--(2,-1)--(2,.839);
\filldraw[fill=white](-2,.985)--(-2,.811)--(2,.811)--(2,.985)--cycle;
\filldraw[draw=none,fill=white](-2,.839)--(2,.839)--(2,1)--(-2,1)--cycle;
\draw(2,.839)--(2,1)--(-2,1)--(-2,.839);
\filldraw[draw=none,fill=white](-2,-.087)--(2,-.087)--(2,.811)--(-2,.811)--cycle;
\draw(2,-.087)--(2,.811)--(-2,.811)--(-2,-.087);
