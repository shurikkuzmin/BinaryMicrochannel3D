...
/*		for(int iX=0;iX<NX;iX++)
		...
		{
			ux[0][iY]=rho1-(f[0][iY][0]+f[0][iY][2]+f[0][iY][4]+2.0*(f[0][iY][3]+f[0][iY][6]+f[0][iY][7])); 
			f[0][iY][1] = f[0][iY][3]+2.0*ux[0][iY]/3.0;
			f[0][iY][5] = f[0][iY][7]+0.5*(f[0][iY][4]-f[0][iY][2])+ux[0][iY]/6.;
			f[0][iY][8] = f[0][iY][6]-0.5*(f[0][iY][4]-f[0][iY][2])+ux[0][iY]/6.;
			// East Boundary :
			ux[NX-1][iY]=-rho2+(f[NX-1][iY][0]+f[NX-1][iY][2]+f[NX-1][iY][4]+2.*(f[NX-1][iY][1]+f[NX-1][iY][5]+f[NX-1][iY][8]));
			f[NX-1][iY][3] = f[NX-1][iY][1]-2.0*ux[NX-1][iY]/3.;
			f[NX-1][iY][7] = f[NX-1][iY][5]-0.5*(f[NX-1][iY][4]-f[NX-1][iY][2])-ux[NX-1][iY]/6.;
			f[NX-1][iY][6] = f[NX-1][iY][8]+0.5*(f[NX-1][iY][4]-f[NX-1][iY][2])-ux[NX-1][iY]/6.;
		}		
		...
		{
			f[iX][0][2] = f[iX][0][4];
			f[iX][0][5] = f[iX][0][7]-0.5*(f[iX][0][1]-f[iX][0][3]);
			f[iX][0][6] = f[iX][0][8]+0.5*(f[iX][0][1]-f[iX][0][3]);
			// Top :
			f[iX][NY-1][4] = f[iX][NY-1][2];
			f[iX][NY-1][7] = f[iX][NY-1][5]+0.5*(f[iX][NY-1][1]-f[iX][NY-1][3]);
			f[iX][NY-1][8] = f[iX][NY-1][6]-0.5*(f[iX][NY-1][1]-f[iX][NY-1][3]);
		}		
		//Corners
		f[0][0][1]=f[0][0][3];
		f[0][0][2]=f[0][0][4];
